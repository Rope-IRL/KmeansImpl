class KMeansClustering:
    ...
    def Manhattan_distance(data_point, centroids):
        ...
        # res = np.absolute(data_point) - np.absolute(centroids)
        return np.sum(np.absolute(data_point - centroids), axis = 1)
    ...
    def fit(self, X, max_iterations = 200):
        ...
        for _ in range(max_iterations):
            ...
            for data_point in X:
                distances = KMeansClustering.Manhattan_distance(data_point, self.centroids)
